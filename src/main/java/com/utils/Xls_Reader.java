...
public class Xls_Reader {
	...
	public boolean addColumn(String sheetName,String colName){
		...
		//style.setFillForegroundColor(XSSFColor.from(Color.BLACK, index));
  ...
  // find whether sheets exists	
	...
	public boolean setCellDataInparticularCell(String testcases,String sheetName,String colName, String data){
		...
		for (int rNum = 1; rNum <= getRowCount(sheetName); rNum++) {
			if (testcases.equalsIgnoreCase(getCellData(sheetName, 0, rNum))) {
				System.out.println(getCellData(sheetName, 0, rNum));
		...
		while (!getCellData(sheetName, cols, columnStartNum).equals("")) {
		...
		while (!getCellData(sheetName, 0, (rowStartNum + rows)).equals("")) {
		...
		for (int rNum = rowStartNum; rNum < (rowStartNum + rows); rNum++) {
			for (int cNum = 0; cNum < cols; cNum++) {
				System.out.print(getCellData(sheetName, cNum, columnStartNum) + "--"+ getCellData(sheetName, cNum, rNum) + " --");
				//System.out.println(getCellData("Test Data", cNum, columnStartNum));
				//System.out.println(getCellData("Test Data", cNum, rNum) + " --");
				if(getCellData(sheetName, cNum, columnStartNum).equalsIgnoreCase(colName)){
					
					int rw =rNum;
					while(rw<(rowStartNum + rows)){
						if(getCellData(sheetName, cNum, rw).equals("")){
	...
	public boolean setCellData1(String sheetName, String colName,int rowNum, String data){
		...
		for(int j=0; j<=sheet.getLastRowNum();j++){
			...
			//System.out.println(sheet.getRow(j).getCell(i).toString().trim()+"---"+col_Num);
			if(sheet.getRow(j).getCell(i).toString().trim().equalsIgnoreCase(colName.trim()))
			{
				//System.out.println(i);
				col_Num=i;
			    break;
