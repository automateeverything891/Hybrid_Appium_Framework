...
public class TestUtils {
	...
	public static boolean isTestsuitesExecutable(String testsuites, Xls_Reader xls){
		
		for(int rNum=2; rNum<=xls.getRowCount("Test Suites"); rNum++){
			
			if(testsuites.equalsIgnoreCase(xls.getCellData("Test Suites", "TSID", rNum))){
				
				//System.out.println(xls.getCellData("Test Cases", "TCID", rNum));
				if(xls.getCellData("Test Suites", "Runmode",rNum).equals("Y")){
					//System.out.println("test cases is runnable");
					return true;
				}
				else{
	...
	public static String isTestSuitesTestCaseName(String testsuites, Xls_Reader xls){
		...
		for(int rNum=2; rNum<=xls.getRowCount("Test Suites"); rNum++){
			...
			if(testsuites.equalsIgnoreCase(xls.getCellData("Test Suites", "TSID", rNum))){
				...
				if(!xls.getCellData("Test Suites", "TestCase Name",rNum).equals("")){
					//System.out.println("test cases is runnable");
					return xls.getCellData("Test Suites", "TestCase Name",rNum);
				}
